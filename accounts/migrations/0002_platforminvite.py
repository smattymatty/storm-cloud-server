        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "key",
                    models.CharField(
                        default=accounts.models.generate_platform_invite_key,
                        max_length=64,
                        unique=True,
                    ),
                ),
                ...
                (
                    ...
                    models.DateTimeField(
                        blank=True, help_text="When the invite was claimed.", null=True
                    ),
                ),
                (
                    "expires_at",
            ...
            options={
                ...
                "ordering": ["-created_at"],
                "indexes": [
                    models.Index(fields=["key"], name="accounts_pl_key_9030f3_idx"),
                    models.Index(fields=["email"], name="accounts_pl_email_fbc6da_idx"),
                    models.Index(
                        fields=["is_active", "is_used"],
                        name="accounts_pl_is_acti_c8cafc_idx",
                    ),
                ],
            },
        ),
