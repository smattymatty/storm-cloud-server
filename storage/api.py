...
class FileCreateView(StormCloudBaseAPIView):
    ...
    @extend_schema(
        ...
        description="Create an empty file at the specified path. Parent directories are created as needed.",
        request=None,
        responses={
            201: FileInfoResponseSerializer,
            400: OpenApiResponse(description="Invalid path"),
    ...
    def post(self, request, file_path):
        ...
        file_info = backend.save(full_path, empty_content)
