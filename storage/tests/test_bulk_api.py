...
class BulkOperationAPITestCase(TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.test_shared_root = settings.BASE_DIR / "shared_storage_test_bulk_api"
    ...
    def test_requires_authentication(self):
        ...
        response = client.post(
            "/api/v1/bulk/",
            {"operation": "delete", "paths": ["test.txt"]},
            format="json",
        )
    ...
    def test_missing_operation_field(self):
        ...
        response = self.client.post("/api/v1/bulk/", {"paths": ["test.txt"]})
    ...
    def test_missing_paths_field(self):
        ...
        response = self.client.post("/api/v1/bulk/", {"operation": "delete"})
    ...
    def test_invalid_operation(self):
        ...
        response = self.client.post(
            "/api/v1/bulk/", {"operation": "invalid", "paths": ["test.txt"]}
        )
    ...
    def test_empty_paths_array(self):
        ...
        response = self.client.post(
            "/api/v1/bulk/", {"operation": "delete", "paths": []}
        )
    ...
    def test_too_many_paths(self):
        ...
        response = self.client.post(
            "/api/v1/bulk/", {"operation": "delete", "paths": paths}
        )
    ...
    def test_move_requires_destination(self):
        ...
        response = self.client.post(
            "/api/v1/bulk/", {"operation": "move", "paths": ["test.txt"]}
        )
    ...
    def test_delete_operation(self):
        ...
        with monitor(response_time_ms=100, query_count=10) as result:
            response = self.client.post(
                "/api/v1/bulk/",
                {"operation": "delete", "paths": ["file1.txt", "file2.txt"]},
            )
        result.explain()
    ...
    def test_delete_partial_failure(self):
        ...
        response = self.client.post(
            "/api/v1/bulk/",
            {"operation": "delete", "paths": ["exists.txt", "missing.txt"]},
        )
    ...
    def test_move_operation(self):
        ...
        self.assertEqual(response.data["succeeded"], 1)
        self.assertEqual(
            response.data["results"][0]["data"]["new_path"], "dest/source.txt"
        )
    ...
    def test_sync_response_format(self):
        ...
        response = self.client.post(
            "/api/v1/bulk/", {"operation": "delete", "paths": ["test.txt"]}
        )
